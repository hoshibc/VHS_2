...
void BlueRight() {
    ...
    MoveEncoderPID(TestPara, 100, 18, 0.2, -128, true);
    wait(100,msec);
    MoveEncoderPID(TestPara, -100, 34, 0.2, -128, true);
    TurnMaxTimePID(TestPara, -87, 0.2, true);
    MoveEncoderPID(TestPara, 100, 32, 0.2, -87, true);
    TurnMaxTimePID(TestPara, -18, 0.4, true);
    MoveEncoderPID(TestPara, 100, 28, 0.2, -18, false);
    
    MoveEncoderPID(TestPara, 60, 13, 0.2, -18, false); 
    wait(500,msec);
