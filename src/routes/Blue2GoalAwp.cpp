...
void Blue2GoalAwp() {
    ...
    RunRoller(100);
    MoveEncoderPID(TestPara, 100, 22, 0.2, -128, true); //get one ring from ring stack 
    wait(200,msec);
    ...
    MoveEncoderPID(TestPara, -30, 25, 0.2, 0, true); //slow move
    ...
    MoveEncoderPID(TestPara, 70, 13, 0.2, -140, true); //move foward to bar
